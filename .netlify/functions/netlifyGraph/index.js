...
const operationsDoc = `query GetMostPlayedTracks @netlify(id: """f7a8c011-690b-4c7b-a2cc-c392581118b5""", doc: """An example query to start with.""") {
  me {
    spotify {
...
exports.fetchGetMostPlayedTracks = (variables, options) => {
  return fetchNetlifyGraph({
    query: operationsDoc,
    operationName: "GetMostPlayedTracks",
    variables: variables,
    options: options || {},
  });
};
...
const functions = {
   ...
   */
  fetchGetMostPlayedTracks: exports.fetchGetMostPlayedTracks,
};
